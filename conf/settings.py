...
CELERY_TASK_ROUTES = (
    {
        'apps.match.tasks.*': {'queue': 'download'},
    }
)
...
CELERY_WORKER_MAX_MEMORY_PER_CHILD = 80000  # Default: no limit
...
WEBHOOK_URL = env('WEBHOOK_URL', cast=str, default='http://192.168.0.1:5000/producer')
